...
public class BuiltInSupportCardRegistry {
    ...
    public static void registerAll(BootstrapContext<SupportCard> bootstrap) {
        bootstrap.register(SAINT_LITE_IAIDO,
                ...
                .addSupporter(ResourceLocation.fromNamespaceAndPath(Umapyoi.MODID, "saint_lite"))
    ...
    private static ResourceKey<SupportCard> register(String id) {
        ResourceKey<SupportCard> loc = ResourceKey.create(SupportCard.REGISTRY_KEY, ResourceLocation.fromNamespaceAndPath(BladesDerby.MODID, id));
        return loc;
    }
}
